...
const igrolendData = [
    {
        ...
        text: 'Погружение в мир интерактивных аттракционов дополненной реальности',
        icon: idea,
    },
    {
        id: 2,
        title: 'интерактивное путешествие',
        text: 'Огромные зрелищные проекции, на стенах и полу, создают невероятную атмосферу приключения, которые заполняться надолго',
        icon: format,
    },
    {
        id: 3,
    ...
    },
    {
        id: 4,
        title: 'уникальный формат',
        text: 'Объединяет детей на праздник и вовлекает в мир фантазий и приключений',
        icon: reality,
    },
    {
        id: 5,
    ...
    },
    {
        id: 6,
        title: 'зона отдыха',
        text: 'Отдохните и насладитесь приятным общением с гостями пока дети погружаются в мир оживший реальности',
        icon: balloons,
    },
];
