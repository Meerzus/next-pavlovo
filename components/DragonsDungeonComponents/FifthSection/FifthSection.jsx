...

            {
                igrolend ? <div className="item">
                        ...
                        <div className="container">
                            ...
                            <p>
                                С помощью специального интерактивного оружия вы можете сражаться с пиратами, зомби, преступниками и многими другими
                            </p>
                        </div>
                    </div>
                    : <div className="item">
...

            {
                igrolend ? <div className="item">
                        ...
                        <div className="container">
                            ...
                            <p>
                                Покори своими обитателями мир морских глубин, космос, Африку, волшебный лес.
                            </p>
                        </div>
                    </div>
                    : <div className="item">
